...
#General variables and their definations 
SpatialDict= {}
TemporalDict={} 
VariableDict={}
...
Spatial_OutList=[] #stored spatial topological relationships
Temporal_OutList=[] #stored temporal topolgical realtionships
Variable_OutList={}
g=Graph()
...
##g= igraph.Graph(edges= [(int(k), 0) for k, v in enumerate (ff)])
##
##plot(g,"Data_network.pdf", layout = g.layout("tree"), vertex_shape='circle', vertex_size=5, edge_width=1)
#Loops to relationships
#i=0

#print '\n Rtree specification:'
#print ('Near minimum overlap factor= '+ str (p.get_near_minimum_overlap_factor()))
#print ('Leaf capacity= '+str(p.get_leaf_capacity()))
#print ('Index capacity= '+ str(p.get_index_capacity()))


#document = Element('outer')
#et = ElementTree('outer')
#f = open("C:/Users/Mostafa/Research/Dropbox/Elag&Kumar/SEAD/Codes/PythonScripts/test.xml", "w")
#et.write(f, encoding='utf-8', xml_declaration=True)
#f.close()
#root=ET.Element("SpatialLeafs")
#for leaf in range(len(tree.leaves())):
   # Leaf=ET.SubElement(root, str(Spatial_Leafs[leaf][0]))
    #field1 = ET.SubElement(Leaf, "field1")
   # field1.set(str(Spatial_Leafs[leaf][0][1][1]))
